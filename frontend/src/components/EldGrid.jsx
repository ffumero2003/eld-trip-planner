...
export default function EldGrid({ day }) {
  ...
  return (
    <div className="mt-6">
      <h3 className="mb-1.5 text-lg font-semibold text-white">{day.date}</h3>
      {/* Fixed-width grid inside a scrollable panel — swipe/scroll on the x-axis. */}
      <div className="overflow-x-auto rounded-lg">
        <svg
          viewBox={`0 0 ${TOTAL_WIDTH} ${TOTAL_HEIGHT}`}
          className="h-auto max-w-none bg-white"
